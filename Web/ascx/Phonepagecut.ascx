<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Phonepagecut.ascx.cs" Inherits="RGPWEB.ascx.Phonepagecut" %>
    ...
    <div style="height: 15px; line-height: 15px;">
        <%--<div style="float: left;">--%>
            ...
            <%--<a href="javascript:void(0)" <%=firstdisabled %> onclick="btnFirst_click(); return false;">
                第一页</a>--%> 
                <a href="javascript:void(0)" <%=firstdisabled %> onclick="btnPre_click(); return false;">
                    上一页</a> <a href="javascript:void(0)" <%=lastdisabled %> onclick="btnNext_click(); return false;">
                        下一页</a> 
                       <%-- <a href="javascript:void(0)" <%=lastdisabled %> onclick="btnLast_click(); return false;">
                            最后一页</a> 转到： </div>
        <div style="float: left;">
