<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientQuery.aspx.cs" 
    MasterPageFile="~/Information/Information.master" Inherits="Information_PatientQuery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">      
        ...
        function SearchInfoList() {
            ...
            document.forms[0].action = "PatientQuery.aspx?type=Information";
    ...
    <div class="nowposition">
        ...
        <%= GetGlobalResourceObject("SystemResource","OrderListManagement").ToString() %> >
        <b><%= GetGlobalResourceObject("SystemResource","OrderList").ToString() %></b></div>  
    
    <div class="zTreeDemoBackground" style="display:none; float: left;position:relative;">
