...
(function (window, $, undefined) {
                        ...
                        $webimg_modal.find('#' + btnId).click(function (e) {
                            ...
                            if (url !== '') {
                                ...
                                if (title === '') {
                                    ...
                                    editor.command(e, 'customeInsertImage', { 'url': url, 'title': "" }, webimg_callback);
                                } else {
                            ...
                            window.wangEditor_uploadImgCallback = function (result) {
                                ...
                                if (result.indexOf('ok|') === 0) {
                                    ...
                                    if (title === '') {
                                        ...
                                        editor.command(e, 'customeInsertImage', { 'url': url, 'title': "" }, uploadImg_callback);
                                    } else {
    ...
    $.extend($E.fn, {
        ...
        'commandHooks': {
            ...
            'customeInsertImage': function (commandName, commandValue) {
                ...
                newImgs.attr('width', "150px");
                newImgs.attr('height', "150px");
            ...
            'commonCapture': function (commandName, commandValue) {
                //this是editor对象
                Capture(this);
            },
    ...
    $.fn.extend({
        ...
        */
        ...
        'appendImage': function (editor12, imageUrl) {
            editor12.$txt.append(imageUrl);
            //editor12.$txtContainer.append(editor12.$txt);
            //editor12.$editorContainer
            //     .append(editor12.$btnContainer)
            //     .append(editor12.$txtContainer)
            //this.before(editor12.$editorContainer);
            this.hide();
            // $E.initSelection();
        }
    ...
    $.extend($E.fn, {
        'hai': function (imageUrl) {
            this.$txtContainer.append($E.$txt);
            this.$editorContainer
                 .append(this.$btnContainer)
                 .append(this.$txtContainer)

            //获取editor对象
            //var editor = this;
            //$E.$txt = $($E.htmlTemplates.txt);
            //$E.$editorContainer = $($E.htmlTemplates.editorContainer);
            //$E.$txtContainer = $($E.htmlTemplates.txtContainer);
            //$E.$txt.append(imageUrl);
            //$E.$txtContainer.append($E.$txt);
            //$E.$editorContainer
            //     .append($E.$btnContainer)
            //     .append($E.$modalContainer)
            //     .append($E.$txtContainer)
            //     .append($E.$elemDeleteBtn)
            //     .append($E.$imgResizeBtn);
