...
using D2012.Common;
using System.Data;
public partial class OrderManagement_addColorForProduct : PageBase
{
    ...
    private void GetSceneryTypeList()
    {
        ...
        DataTable dt = facservComm.ExecuteSqlDatatable("SELECT [DictName] as ColorType FROM [DictDetail] where ClassID  = 'Color' order by sortno");
