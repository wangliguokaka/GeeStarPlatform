<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HistoryTalk.aspx.cs" Inherits="Weixin_HistoryTalk" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReturnSuccess(data, iPageIndex) {
            ...
            if (iPageCount>0){
                $("#dcommentbox").html("<tr><th style=\"width:150px;\"><%= GetGlobalResourceObject("Resource","TalkRecord").ToString() %></th><th style=\"width:50px;\"><%= GetGlobalResourceObject("Resource","TalkTime").ToString() %></th><th style=\"width:100px;\"><%= GetGlobalResourceObject("Resource","User").ToString() %></th></tr>");
                $.each(data.replyJson, function (i, item) {
                    $("#dcommentbox").append("<tr><td style=\"text-align:left;\">" + item.TalkMessage + "</td><td>" + item.TalkTime + "</td><td>" + item.TalkUser + "</td></tr>");
                    icounti++;
                });
...
<body>
    ...
    <div style="height:360px; width:300px; overflow:auto;">
        <table id="dcommentbox" style="width:300px;font-size:12px; text-align:left;" class="tlist">
            <tr><td></td></tr>
        </table>
