<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmDeList.aspx.cs" 
     MasterPageFile="~/ReportStatistics/ReportStatistics.master" Inherits="ReportStatistics_ConfirmDeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="height:70%;">
        <rsweb:ReportViewer ID="ConfirmDeList" runat="server" Font-Names="Verdana" PageCountMode="Actual" Font-Size="8pt"  Height="100%" CssClass="reportView" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReportStatistics\Rdlc\ConfirmDeList.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
     </div>
</asp:Content>