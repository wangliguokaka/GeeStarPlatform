<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductPrice.aspx.cs" 
    MasterPageFile="~/ReportStatistics/ReportStatistics.master" Inherits="ReportStatistics_ProductPrice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="nowposition">
       ...
       <b><%= GetGlobalResourceObject("SystemResource","PriceList").ToString() %>&nbsp;</b></div> 
     ...
     <div style="height:70%;">
           ...
           <rsweb:ReportViewer ID="FinanceReportViewer" runat="server" Font-Names="Verdana" PageCountMode="Actual" Font-Size="8pt" CssClass="reportView" Height="100%" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReportStatistics\Rdlc\ProductPrice.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
