<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipRec.aspx.cs" 
    MasterPageFile="~/ReportStatistics/ReportStatistics.master" Inherits="ReportStatistics_EquipRec" %>
       ...
       <b><%= GetGlobalResourceObject("SystemResource","SelectDebt").ToString() %>&nbsp;</b></div> 
           <div style="height:80%;">
                <rsweb:ReportViewer ID="FinanceReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" CssClass="reportView" Height="100%"  WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                    <LocalReport ReportPath="ReportStatistics\Rdlc\EquipRec.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>
            </div>
