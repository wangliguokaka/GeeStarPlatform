<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrdersElement.aspx.cs" 
    MasterPageFile="~/ReportStatistics/ReportStatistics.master" Inherits="ReportStatistics_OrdersElement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="nowposition">
       ...
       <b><%= GetGlobalResourceObject("SystemResource","MaterialCompositionAndLotNumber").ToString() %>&nbsp;</b></div> 
    <div style="height:80%">
    <rsweb:ReportViewer ID="FinanceReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" CssClass="reportView"  Height="100%" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReportStatistics\Rdlc\OrdersElement.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
        </div>
