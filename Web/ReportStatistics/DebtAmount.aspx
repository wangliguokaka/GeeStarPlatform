<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DebtAmount.aspx.cs" 
    MasterPageFile="~/ReportStatistics/ReportStatistics.master" Inherits="ReportStatistics_DebtAmount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="height:80%;"> 
           <rsweb:ReportViewer ID="FinanceReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt"  Height="100%" CssClass="reportView" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReportStatistics\Rdlc\DebtAmount.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
        </div>
